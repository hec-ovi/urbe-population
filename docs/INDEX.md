...
| --- | --- | --- | --- | --- |
| [Simulation](../CONTRACT.md) | Computes population, identities and gameplay continuity. | [SimulationInput](../src/schemas/input.ts) | [Population](../src/schemas/population.ts), [crowd](../src/schemas/crowd.ts), [NPC](../src/schemas/npc.ts), [continuity](../src/schemas/npc-continuity.schema.json), [save](../src/schemas/simulation-save.schema.json) | Atlas blueprint, Connections networks, Interior NPC support, Naming types |
...
- [ISSUES.md](ISSUES.md): open questions that need cross-box coordination.
