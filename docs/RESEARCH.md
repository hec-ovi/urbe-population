...
- Housing stock: units per residential parcel are floor area over the tier's unit size (45, 70, 110, 180 m2 from poor to high_rich) at 55% occupancy. The atlas blueprint's own population estimate is the world's truth, so that unit estimate is scaled by one published factor until residents agree within 3 percent; occupancy stays put.
